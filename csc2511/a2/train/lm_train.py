...
def lm_train(data_dir, language, fn_LM):
    ...
    for subdir, dirs, files in os.walk(data_dir):
        for file in files:
            if language == 'e' and re.match(r"[\S]+\.e", file):
            ...
            elif language == 'f' and re.match(r"[\S]+\.f", file):
                fullFile = os.path.join(subdir, file)
                f = open(fullFile)
...
if __name__ == "__main__":
    # lm_train("/u/cs401/A2_SMT/data/Toy/", "e", "/h/u8/c8/00/chenyil2/Desktop/csc2511/a2/lm")
    lm_train("/u/cs401/A2_SMT/data/Hansard/Training/hansard.36.1.house.debates.192.e", "e", "/h/u8/c8/00/chenyil2/Desktop/csc2511/a2/lm")
